      ...
      $scope.updateReassignment=  function (stockId){
        var item=$scope.stock.IMEI;
         var stock=$scope.guarantee.idStock;
          ...
          Stock.prototype$patchAttributes({id: stock},{salesPrice: null, status: "guarantee", confirmSale: false, idClient: null, saleDate: null, validate: false, args:{ data: { description: "Equipo nuevamente reasignado al ejecutivo", status:'guarantee' }}}).$promise
           .then(
             function(response) {
